...
DECLARE_SPELL_FUN(	spell_physical_recover	);
DECLARE_SPELL_FUN(	spell_mental_recover	);
DECLARE_SPELL_FUN(	spell_energy_recover	);
DECLARE_SPELL_FUN(	spell_fireshield		);
DECLARE_SPELL_FUN(	spell_discern_weakness	);
DECLARE_SPELL_FUN(	spell_minsc_power		);
DECLARE_SPELL_FUN(	spell_venom_lance		);
DECLARE_SPELL_FUN(	spell_holy_armor		);
DECLARE_SPELL_FUN(	spell_greater_healing	);
DECLARE_SPELL_FUN(	spell_fanatic_flame		);
DECLARE_SPELL_FUN(	spell_vise_grip			);
DECLARE_SPELL_FUN(	spell_hold_person		);
DECLARE_SPELL_FUN(	spell_giga_blast		);
DECLARE_SPELL_FUN(	spell_supernova		);
DECLARE_SPELL_FUN(	spell_elemental_shield	);
DECLARE_SPELL_FUN(	spell_thermonuclear		);
DECLARE_SPELL_FUN(	spell_dragonfury		);
DECLARE_SPELL_FUN(	spell_repulsar		);
DECLARE_SPELL_FUN(	spell_heavenly_justice	);
DECLARE_SPELL_FUN(	spell_divine_right		);
DECLARE_SPELL_FUN(	spell_mystic_sight		);
DECLARE_SPELL_FUN(	spell_mind_thrust		);
DECLARE_SPELL_FUN(	spell_mind_blast		);
DECLARE_SPELL_FUN(	spell_mind_crush		);
DECLARE_SPELL_FUN(	spell_elemental_wrath	);
DECLARE_SPELL_FUN(	spell_skeleton_dance	);
DECLARE_SPELL_FUN(	spell_insanity			);
DECLARE_SPELL_FUN(	spell_judgement			);
DECLARE_SPELL_FUN(	spell_spectral_hand		);
DECLARE_SPELL_FUN(	spell_runic_scribing	);
DECLARE_SPELL_FUN(	spell_rune_warding		);
DECLARE_SPELL_FUN(	spell_exodus			);
