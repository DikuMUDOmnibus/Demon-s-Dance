...
DECLARE_SPEC_FUN(	spec_cast_super		);
DECLARE_SPEC_FUN(	spec_exp_changer	);
...
const   struct  spec_type    spec_table[] =
{
	...
	{	"spec_cast_super",		spec_cast_super		},
	{	"spec_exp_changer",		spec_exp_changer	},
...
bool spec_breath_any( CHAR_DATA *ch )
{
    ...
    case 1: cast_dispel(ch);	return spec_breath_lightning(ch);
    case 2: return spec_breath_lightning	( ch );
    case 3: return spec_breath_gas		( ch );
    case 4: return spec_breath_acid		( ch );
    case 5: cast_dispel(ch);	return spec_breath_lightning(ch);
    case 6: cast_dispel(ch);	return spec_breath_lightning(ch);
...
bool spec_cast_super( CHAR_DATA *ch )
{
    CHAR_DATA *victim;
    CHAR_DATA *v_next;
    char *spell;
	...
	switch ( number_bits( 4 ) )
	{
	case  0: min_level =  100; spell = "blindness";      break;
	case  1: min_level =  100; spell = "dispel magic";    break;
	case  2: min_level =  100; spell = "weaken";         break;
	case  3: min_level =  100; spell = "chill touch";       break;
	case  4: min_level =  100; spell = "curse";   break;
	case  5: min_level =  100; spell = "flamestrike";     break;
	case  6: min_level =  100; spell = "shocking grasp";   break;
	case  7:
	case  8:
	case  9: min_level = 100; spell = "fireball";       break;
	case 10: min_level = 100; spell = "plague";	   break;
	default: min_level = 100; spell = "acid blast";     break;
	}
...
bool spec_exp_changer (CHAR_DATA *ch)
{
    if (ch->fighting != NULL) return spec_cast_mage( ch );
    return FALSE;
}
...
bool spec_snake_charm( CHAR_DATA *ch )
{
    ...
    {
	v_next = victim->next_in_room;
	if ( victim->fighting == ch && number_bits( 10 ) == 0 )
	    break;
    }
	...
	act( "{W$n {Wbegins playing a new, beautiful song.", ch, NULL, NULL, TO_ROOM );
...
{    
	...
	switch (number_range(0,10))
	{
		...
		case 8: case 9:	case 10:
		{
			...
			{
				victim = ch->fighting;
				/*sn = skill_lookup( "insanity");
				(*skill_table[sn].spell_fun) ( sn, ch->level, ch, victim,TARGET_CHAR);*/
				stc("You weren't strong enough to dispel their magic!",ch);
				return;
			}
			else
			{
