...
/*  {   command		function	}, */
	...
	{	"weapon_spell",	oedit_weapon_spell	},/* ENZO */
...
/*  {   command		function	}, */
	...
	{   "clan",         medit_clan      },  /* Feydrex - clan guards */
...
void do_redit( CHAR_DATA *ch, char *argument )
{
	...
	if ( !str_cmp( arg1, "reset" ) )	/* redit reset */
	{
		...
		{
			send_to_char( "Insufficent security to modify target.\n\r" , ch );
			return;
		}
	...
	else if( !str_cmp( arg1, "delete" ) )
	{
		...
		else if ( !IS_NULLSTR(arg1) )	/* redit <vnum> */
		{
			...
			if ( !IS_BUILDER(ch, pRoom->area) )
			{
				send_to_char( "REdit : Insufficent security to edit room\n\r", ch );
				return;
			}
...
void do_oedit( CHAR_DATA *ch, char *argument )
{
	...
	if ( is_number( arg1 ) )
	{
		...
		{
			send_to_char( "Insufficent security to modify object.\n\r" , ch );
			return;
		}
...
void do_resets( CHAR_DATA *ch, char *argument )
{
	  ...
	  || (!str_cmp( arg2, "obj" ) && is_number( arg3 )) )
	{
		...
		if (get_mob_index( is_number(arg3) ? atoi( arg3 ) : 1 ) == NULL)
		  {
		    send_to_char("That mob vnum does not exist.\n\r",ch);
		    return;
		  }
		...
		if ( !str_prefix( arg4, "inside" ) )
		{
		    ...
		    if ( ( temp->item_type != ITEM_CONTAINER ) 
				...
				&& ( temp->item_type != ITEM_GOLEM_BAG	))
		     {
		       send_to_char( "The second object you provided is not a container\n\r", ch);
		       return;
		     }
		    pReset->command = 'P';
		...
		if ( !str_cmp( arg4, "room" ) )
		{
		    if (get_obj_index(atoi(arg3)) == NULL)
		      {
		         send_to_char( "The vnum you supplied does not exist\n\r",ch);
		         return;
		      }
		    pReset->command  = 'O';
		    pReset->arg2     = 0;
